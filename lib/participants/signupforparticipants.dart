...
import 'package:koalytics/home_researcher.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 117, 184, 232), // Customize app bar color
      ),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    labelStyle: TextStyle(
                      fontFamily: 'Tommy', // Set your custom font for the label
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
  ...
  void _navigateToHomePage() {
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) => const HomeResearcher(),
